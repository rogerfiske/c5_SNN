...
- **CLI commands:** validate-data, train, evaluate, compare
...
- **Real benchmark numbers:** To be generated by running `compare` on full CA5 dataset

## Test Coverage

- **Total tests:** 235 (all passing)
- **Test files:** test_validation, test_loader, test_logging_setup, test_seed, test_config, test_windowing, test_splits, test_baselines, test_metrics, test_evaluate_cli, test_train, test_compare

## Next Actions

- Sprint 4: snnTorch integration, spike encoding, Spiking MLP, Spiking 1D-CNN, Phase A comparison.
- Run `c5_snn compare` on real CA5 data to get actual baseline benchmark numbers.
